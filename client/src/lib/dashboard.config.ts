  ...
  clients: [
    {
      ...
      materials: [
        { label: "Account Brief", url: "https://docs.google.com/document/d/MAGALU_BRIEF", type: "doc" },
        { label: "Q1 2026 QBR Deck", url: "https://docs.google.com/presentation/d/MAGALU_QBR", type: "slides" },
        { label: "AR Tracker", url: "https://docs.google.com/spreadsheets/d/MAGALU_AR", type: "sheet" },
      ],
    },
    {
      id: "samsung",
      ...
      materials: [
        { label: "Account Brief", url: "https://docs.google.com/document/d/SAMSUNG_BRIEF", type: "doc" },
        { label: "Q1 2026 QBR Deck", url: "https://docs.google.com/presentation/d/SAMSUNG_QBR", type: "slides" },
      ],
    },
    {
      id: "amazon",
      ...
      materials: [
        { label: "Account Brief", url: "https://docs.google.com/document/d/AMAZON_BRIEF", type: "doc" },
        { label: "Q1 2026 QBR Deck", url: "https://docs.google.com/presentation/d/AMAZON_QBR", type: "slides" },
      ],
    },
    {
      id: "abi",
      ...
      materials: [
        { label: "Account Brief", url: "https://docs.google.com/document/d/ABI_BRIEF", type: "doc" },
      ],
    },
    // To add a new client, copy a block above and fill in your values.
    // To remove a client, delete their block.
    // For each client, add materials: an array of { label, url, type } objects.
    // Supported types: "doc", "sheet", "slides", "link", "folder"
  ],
};
