...
// Populated by Manus on 2026-03-13 from Workplace (fb.workplace.com)
...
export const mentionsAndTags: WorkplacePost[] = [
  ...
  // Last attempted: 2026-03-13. Re-run after granting Workplace access.
];
...
// ── Digest metadata ───────────────────────────────────────────────────────────
export const digestDate = "2026-03-13";
